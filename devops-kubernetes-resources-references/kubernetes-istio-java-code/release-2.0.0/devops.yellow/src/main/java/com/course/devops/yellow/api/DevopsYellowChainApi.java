...
public class DevopsYellowChainApi {
  ...
  public ResponseEntity<String> chainOne(HttpServletRequest request, 
    ...
    final var statusCode = listStatusCode.get(RandomUtils.insecure().randomInt(0, listStatusCode.size()));
    ...
    sb.append(StringUtils.LF);
    sb.append(String.format(CONTENT_WHITE_STRING, whiteApiClient.status(headersMap, responseStatusCode)));
