...
import com.course.devops.yellow.api.response.HelloTimeResponse;
import com.course.devops.yellow.constant.DevopsApiConstants;
import com.course.devops.yellow.filter.ApiResponseFilter;
import com.course.devops.yellow.load.CpuLoadThread;
import com.course.devops.yellow.load.MemoryLoadThread;
...
@RestController
@RequestMapping("/api")
@Tag(name = "DevOps-Yellow custom API", description = "DevOps-Yellow custom API")
@Slf4j
@Validated
public class DevopsYellowApi {
