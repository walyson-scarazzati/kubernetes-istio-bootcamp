...
public class DevopsBlueApi {
  ...
  public ResponseEntity<Resource> loadImage(
    ...
    if (file != null) {
      var contentType = MediaTypeFactory.getMediaType(file.getFilename())
          .map(Object::toString)
  ...
  public ResponseEntity<Resource> loadPdf(
    ...
    if (file != null) {
      String contentType = MediaTypeFactory.getMediaType(file.getFilename())
          .map(Object::toString)
  ...
  public ResponseEntity<String> uploadDoc(@RequestPart(name = "file") MultipartFile file) throws IOException {
